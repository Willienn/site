...
export const Heading1: React.FC<{ children: ReactNode }> = ({ children }) => (
  <h1 className="mb-2 mt-8 font-roboto_slab tracking-tight text-2xl no-underline md:text-4xl">
    {children}
  </h1>
)

export const Heading2: React.FC<{ children: ReactNode }> = ({ children }) => (
  <h2 className="mb-2 mt-8 font-roboto_slab tracking-wide text-lg md:text-2xl lg:text-3xl">
    {children}
  </h2>
)

export const Heading3: React.FC<{ children: ReactNode }> = ({ children }) => (
  <h3 className="mb-2 mt-8 font-roboto_slab tracking-wide text-lg md:text-xl lg:text-2xl">
    {children}
  </h3>
)
...
export const Paragraph: React.FC<{ children: ReactNode }> = ({ children }) => (
  <span className="mb-4 block">{children}</span>
)

export const OrderedList: React.FC<{ children: ReactNode }> = ({
  children,
}) => <ol className="mb-4 ml-5 list-decimal space-y-2">{children}</ol>

export const UnorderedList: React.FC<{ children: ReactNode }> = ({
  children,
}) => <ul className="mb-4 ml-5 list-disc space-y-2">{children}</ul>
...
export const InlineCode: React.FC<{ children: ReactNode }> = ({ children }) => (
  <code className="mb-4 rounded bg-red-500 px-1 py-0.5">{children}</code>
)
